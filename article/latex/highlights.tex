...
\section*{Highlights}
\begin{itemize}
  \item [RESULT TO BE GENERATED] % 1. Achado central: a janela única muda o que o Estado registra (CobSantosPre -> CobSantosPos) [REVER 23/09: e um caso (Santos), nao efeito medio]
  \item [RESULT TO BE GENERATED] % 2. Tempos agregados: nenhum efeito robusto (TdoisPwcbFull, TquatroPwcbFull)
  \item [RESULT TO BE GENERATED] % 3. [REVER 23/09: efeito da cabotagem nao sobrevive a pre-tendencias — tab:pretrend] Efeito localizado: cabotagem recorrente, T4
